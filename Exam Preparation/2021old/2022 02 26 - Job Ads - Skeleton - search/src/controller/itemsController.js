...
router.get('/:itemsId/details', async (req, res) => {
    ...
    let likedUsersDescriptionsString = likedUsersDescriptions.join(", ");//!
    //
    ...
    res.render('items/details', { ...
        ...
        likedUsersUsernamesString, likedUsersEmailsString,likedUsersDescriptionsString,userDescription,userEmail });
});
