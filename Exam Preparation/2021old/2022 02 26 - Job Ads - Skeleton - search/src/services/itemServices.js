...
exports.getOne = (itemsId) => Items.findById(itemsId).populate('applied');//!

//profile
exports.getMyCreatedPost = (userId) => Items.find({ author: userId }).lean();//!

exports.getMyLikedPosts = (userId) => Items.find({ applied: userId}).lean();//!
